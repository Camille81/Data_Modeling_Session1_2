...
class Point:
    ...
    def distance_orig(self): # compute distance to origine
    ...
    def __eq__(self, other):
        return self.distance_orig() == other.distance_origin()



p1 = Point(1,2) # create a new instance of a point
p2 = Point(3,4)
...
points = []
for i in range(5):
    p = Point( #create a random point
        random.randint(-100,100),
    random.randint(-100, 100)
    )
    points.append(p) #append it to the list
